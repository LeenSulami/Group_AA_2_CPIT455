<%-- 
    Document   : Delete
    Created on : 17 Aug 2022, 23:44:16
    Author     : rnema
--%>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        ...
        <%
            ...
            int isDeleted = person.DeleteInformtaion(ID);
            if(isDeleted > 0) {
   ...
   <div class="container content ">
    <div class="row pt-5">
        <div class=" column ">
            ...
            <p class="d-flex justify-content-center"> Your Account Has Been Successfully Deleted </p>
